export interface CampusLocationLevel2 {
  name: string;
  level3: string[];
}

export interface CampusLocationLevel1 {
  name: string;
  level2: CampusLocationLevel2[];
}

export const LOCATIONS_DATA: CampusLocationLevel1[] = [
  {
    name: "HPSB",
    level2: [
      {
  ...
  },
  {
    ...
    level2: Array.from({ length: 3 }, (_, index) => ({
      name: `${index + 1} Floor`,
